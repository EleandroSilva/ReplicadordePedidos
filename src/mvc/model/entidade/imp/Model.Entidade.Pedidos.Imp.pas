...
type
  TEntidadePedidos <T : iInterface> = class(TInterfacedObject, iEntidadePedidos<T>)
    ...
    public
      ...
      function FiltroComVirgula          (Value : Integer) : iEntidadePedidos<T>; overload;
      function FiltroComVirgula                            : Integer;             overload;
...
function TEntidadePedidos<T>.FiltroComVirgula(Value: Integer): iEntidadePedidos<T>;
begin
  Result := Self;
  FFiltroComVirgula := Value;
end;

function TEntidadePedidos<T>.FiltroComVirgula: Integer;
begin
  Result := FFiltroComVirgula;
end;
...
begin
  ...
  cdsPedidos.FieldDefs.Add('Id'                         , ftInteger , 0, False);  // String de até 5 caracteres
